import 'package:itunes_podcast_search/src/model/genre.dart';
...
class Item {
  ...
  factory Item.fromJson({required Map<String, dynamic>? json, ResultType type = ResultType.itunes}) {
    return type == ResultType.itunes ? _fromItunes(json!) : _fromCustomApi(json!);
  }
  ...
  static Item _fromCustomApi(Map<String, dynamic> json) {
